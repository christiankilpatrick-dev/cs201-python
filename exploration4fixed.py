...
def load_employees():
    """
    Returns the list of all employees, each of whom has a name and
    ...
    [
        ...
        {"name":"Cassie Cassiopeia","jobs":[
            {"org":"HR Admin", "pct":100, "salary":190000}
        ]}, ...
    ]
    """
...
CAUTION = "\nADAPTED from public-use data published by Oregon State University\nSalary figures were randomly adjusted and are NOT exactly accurate\nOnly unclassified salaries are included (and, as noted, were randomly adjusted)\n"
print(CAUTION)
